...
namespace OpenHeroSelectGUI.Settings
{
    ...
    // Temporary, successfully tested class for binding. No binding at this time.
    public partial class Game : ObservableRecipient
    {
        [ObservableProperty]
        ...
        partial void OnMUAChanged(bool value)
        {
            UpdateFolder(!value);
        }
